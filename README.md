...
7. TreeVoyager: An LLM-based DOM parser (using GPT-4 Turbo) designed to implement some principles from the papers ['Tree of Thoughts'](https://arxiv.org/abs/2305.10601) (ToT) and ['Minecraft's Voyager'](https://arxiv.org/abs/2305.16291). **In simpler terms:**, the way it works is you provide a task to it (e.x. "buy coffee") on a website and it returns the HTML/DOM element of the page your (agent) should interact with.
